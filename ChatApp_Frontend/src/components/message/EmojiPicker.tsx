...
const EmojiPicker: React.FC<EmojiPickerProps> = ({ isOpen, onClose, onEmojiSelect, isDark }) => {
  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-end justify-center z-50 md:items-center">
      <div className={`w-full max-w-md mx-4 mb-4 md:mb-0 rounded-2xl shadow-2xl ${
        ...
        {/* Category Tabs */}
        <div className={`flex border-b ${isDark ? 'border-gray-700' : 'border-gray-200'} px-2`}>
